...
const FaqSection = () => {
    ...
    return (
        <Box>
            ...
            <Heading as="h2" size="l" w="100%" textAlign={"Center"}>
                            ...
                            {faqSection && faqSection.map((faq, key) => {
                                return (
                                    <AccordionItem key={key} p={1} m={2}>
                                        <h2>
                                            <AccordionButton>
                                                <Box as="span" flex='1' textAlign='left' fontWeight={"bold"} color="white">
                                                    {faq.title}
                                                </Box>
                                                <AccordionIcon />
                                            </AccordionButton>
                                        </h2>
                                        <AccordionPanel pb={4} color="#f0e9e9" fontWeight={400}>
                                            {faq.Info}
                                        </AccordionPanel>
                                    </AccordionItem>
                                )
