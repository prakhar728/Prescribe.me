        ...
        <Box width="100%" display={"flex"} alignItems="center" height="82vh" >
            <Box w="60%" display="flex" flexDirection={"column"} height="80%"  alignItems={"center"}  >
                <Box height="40%" display={"flex"} flexDirection="column" justifyContent="center" alignItems={"center"} w="100%">
                    ...
                    <Text w="40%" fontSize={"lg"}>Save all your Prescriptions and Medical records on-chain!</Text>
                </Box>
                <Text  w="40%" fontSize={"lg"}>The days where you had to worry about keeping all your medical records, mark your visits and keep all your prescriptions saved are over. We save them all for you, with an easy to use interface and connectivity we have your back!</Text>
                ...
                >
                    <Button variant="solid" backgroundColor="#82AAE3" color="black"
                        ...
                        borderRadius={40}
                         > <Link as={RouterLink} to="/app/choices" fontWeight={"300"} 
                         fontSize="xl"> Less Gooo</Link> </Button>
                </Box>
            </Box>
